...
public class EngineerTest extends AbstractCharacterTest{
    ...
    void constructorTest() {
        ...
        checkConstruction(new Engineer(ENGINEER_NAME, turns,10,4,5),
                testCharacters.get(1),
                new Engineer(ENGINEER_NAME, turns,11,4,5),
                new BlackMage(ENGINEER_NAME,turns,10,10,10,10,10));
        checkConstruction(new Engineer(ENGINEER_NAME, turns,10,4,5),
                testCharacters.get(1),
                new Engineer(ENGINEER_NAME, turns,10,5,5),
                new BlackMage(ENGINEER_NAME,turns,10,10,10,10,10));
        checkConstruction(new Engineer(ENGINEER_NAME, turns,10,4,5),
                testCharacters.get(1),
                new Engineer(ENGINEER_NAME, turns,10,4,6),
                new BlackMage(ENGINEER_NAME,turns,10,10,10,10,10));
    }
